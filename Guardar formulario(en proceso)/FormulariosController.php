...
class FormulariosController extends Controller
{
    ...
    public function list_formularios(){
        ...
        //Puede ser validado a tra vez de metodo $_GET o por $response.
        $values = ['4'];
    ...
    public function crear_formulario(Request $request){
        ...
        //var_dump($values);
        //DB::insert('insert into formulario (id_formulario,id_usuario,nombre_formulario) values (?,?,?)',[10,4,'test']);
