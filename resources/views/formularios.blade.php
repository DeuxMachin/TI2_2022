        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <td>
                    ...
                    <a href="/formularios/ver/{{$dato->id_formulario}}" class="btn btn-success">Ver</a>
                    
                    <button value="{{$dato->id_formulario}}" class="btn btn-danger" name ="id_formulario">Eliminar</button></td>
                </tr>
                @endforeach
            </tbody>
        </table>
