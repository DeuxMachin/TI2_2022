...
Route::post('/formularios', [CrudController::class, 'Eliminar_form']);

Route::get('/papelera', [FormulariosController::class, 'papelera']);
Route::post('/papelera', [CrudController::class, 'papelera_res']);
...
Route::post('/formularios/editar/{id}', [CrudController::class,'Editar']);
