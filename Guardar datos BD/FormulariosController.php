...
public function id_paraformulario(Request $request){
        $num = 20;
        return(num);
    ...
    public function crear_formulario(Request $request){
        ...
        //$nombre = $_GET['nombre_formulario'];
        //var_dump($values);
        DB::insert('insert into formulario (id_formulario,id_usuario,nombre_formulario) values (?,?,?)',[id_paraformulario(),4,'test']);
